...
public class Lexer/*@bgen(jjtree)*/implements LexerTreeConstants, LexerConstants {/*@bgen(jjtree)*/
  protected static JJTLexerState jjtree = new JJTLexerState();public static boolean jumpLine = false;

        public static void readFromTerminal() throws Throwable {
                jumpLine = true;
                String code = "", current = "";
                Scanner reader = new Scanner(System.in);
                Lexer lexer = new Lexer(new BufferedReader(new StringReader("")));
                System.out.println("Bota teu codigo ai guri:");
                do {
                        System.out.print(">> ");
                        current = reader.nextLine() + "\u005cn";
                        lexer.ReInit(new BufferedReader(new StringReader(current)));
                        lexer.main();
                        code += current;
                } while(!current.contains("pareHome"));
                lexer.ReInit(new BufferedReader(new StringReader(code)));
                execute(lexer);
        }
        ...
        public static String getPathFromSelectedFile() throws Throwable {
                System.out.println("Tu trata de pega o arquivo ai entao:\u005cn");
 ...
 /*@bgen(jjtree) retornoDeFuncao */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x68000000,0x68000000,0x800001,0x180,0x180,0x0,0x0,0x68000000,0x1f80,0x400000,0x3fdf80,0x180,0x3fdf80,0x1f80,0xfc000,0x300000,0x1f80,0x180,0x400000,0x180,0x300000,0x0,0xfdf80,0x180,0x0,0x2000,0x0,0x400180,0x0,0x0,0x0,0x5000000,0x6a000000,0x5000000,0x4000000,0x0,0x6a000000,0x1000000,0x6a000000,0x0,0x0,0x2000,0x0,0x5000000,0x10000000,0x7a000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x19e3a,0x19e3a,0x0,0x0,0x0,0x19e18,0x19e18,0x2,0x0,0x0,0x0,0x51c090,0x0,0x0,0x0,0x0,0x0,0x518090,0x0,0x51c090,0x0,0x18000,0x0,0x500010,0x1e00,0x0,0x40,0x51c090,0x40,0x18,0x400000,0x0,0x19e3a,0x0,0x0,0x24,0x19e3e,0x2,0x19e3a,0x1e00,0x3e00,0x0,0x40,0x0,0x19e38,0x19e3a,};
   }
